...
`learning-doc-writer` 是一个 Claude Code 全局 Skill，用于自动生成结构清晰、数学严谨、代码可运行的中文技术学习文档。当你输入「写一份关于 XXX 的学习文档」时，它会按照固定的学术写作规范，自动生成包含定义拆解、公式推导、手算推演、完整可运行代码和全景对比表的完整教程。
